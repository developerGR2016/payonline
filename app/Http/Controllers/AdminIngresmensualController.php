<?php namespace App\Http\Controllers;
	...
	class AdminIngresmensualController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function __construct() {
			...
			$this->col[] = ["label"=>"Local","name"=>"local"];
			...
			$this->form[] = ["label"=>"Local","name"=>"local","type"=>"number","validation"=>"required|integer|min:0","width"=>"col-sm-10"];
