<?php namespace App\Http\Controllers;
	...
	class AdminCcIngresoMensualController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function __construct() {
			...
			$this->form[] = ["label"=>"Monto","name"=>"monto","type"=>"money","validation"=>"required|min:3|max:255","width"=>"col-sm-10"];
